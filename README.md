...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p af0c086f-7b3f-40fd-801e-ab37ad3e3ece
```

> `af0c086f-7b3f-40fd-801e-ab37ad3e3ece` is the password of the certificate, you can change it to any password you want.
